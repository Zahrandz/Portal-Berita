<body>
    ...
    <div class="row vr-gallery">
        <?php
        $sql_dh = "SELECT `id_artikel`,`judul`, DATE_FORMAT(`insert_at`, '%d-%m-%Y'), `cover`,`isi` FROM `artikel` WHERE `id_kategori_berita` = 25 LIMIT 0,4";
        ...
        ?>
            ...
            <div class="blog-box row">
                <div class="col mb-4">
                    <div class="row">
                        <div class="col-md-12 col-lg-7 pr-0 pd-md"><a href="index.php?include=articl" title="">
                        ...
                        <div class="col-md-12 col-lg-5 light-bg cus-pd cus-arrow-left">
                            ...
                            <h3><a href="index.php?include=articl" title=""><?php echo $judul ?></a>
                            </h3>
                            <p>
